Prompt 1:
Create a Java Swing program in a single file called SnakeGame.java.
It should have a main method that opens a JFrame window sized 600x600 titled "Snake".
Inside it, add a JPanel subclass called GamePanel.
